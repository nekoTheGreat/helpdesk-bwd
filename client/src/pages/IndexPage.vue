	...
	<q-page class="q-pa-sm">
		<div class="row reverse">
			<q-btn color="primary" text-color="secondary" label="Signup" type="a" :to="{ path: '/register' }"
				class="q-ml-sm" />
			<q-btn color="primary" text-color="secondary" label="Login" class="q-ml-sm" type="a"
				:to="{ path: '/login' }" />
		</div>
		<div class="row">
			<div class="col-12 col-sm-7">
				<div class="q-pa-sm">
					<h4 class="text-center q-mt-none text-weight-bold text-primary">Welcome to Bansalan Water District's
						Helpdesk
					</h4>
